...
if os.name == "nt":
    python_root = os.path.dirname(os.path.dirname(os.path.abspath(os.__file__)))
    os.environ.setdefault("TCL_LIBRARY", os.path.join(python_root, "tcl", "tcl8.6"))
    os.environ.setdefault("TK_LIBRARY", os.path.join(python_root, "tcl", "tk8.6"))
